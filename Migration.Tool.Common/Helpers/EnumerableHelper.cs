...
{
    public static SimpleAligner<TLeft, TRight, TKey> CreateAligner<TLeft, TRight, TKey>(IEnumerable<TLeft> eA, IEnumerable<TRight> eB, IEnumerable<TKey> eK, SimpleAligner<TLeft, TRight, TKey>.SelectKey<TLeft> selectKeyA,
        SimpleAligner<TLeft, TRight, TKey>.SelectKey<TRight> selectKeyB, bool disposeEnumerators)
