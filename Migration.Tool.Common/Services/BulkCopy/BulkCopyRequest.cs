...
///     Data exclusion - use for data validation and data exclusion when you know, that data will not
///     satisfy target DB constraints
/// </param>
...
public record BulkCopyRequest(
    ...
    Func<IDataReader, bool> DataFilter,
    int BatchSize,
    List<string>? Columns = null,
    ValueInterceptor? ValueInterceptor = null,
    ValueInterceptingReaderSkippedRow? SkippedRowCallback = null,
    string? OrderBy = null);
...
public record BulkCopyRequestExtended(
    ...
    ValueInterceptor? ValueInterceptor = null,
    ValueInterceptingReaderSkippedRow? SkippedRowCallback = null,
    string? OrderBy = null) : BulkCopyRequest(TableName, ColumnFilter, DataFilter, BatchSize, ColumnsMapping.Keys.ToList(), ValueInterceptor, SkippedRowCallback, OrderBy);
