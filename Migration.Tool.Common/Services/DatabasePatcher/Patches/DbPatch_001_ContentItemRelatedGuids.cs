...
namespace Migration.Tool.Common.Services.DatabasePatcher.Patches;
...
// is not in use.
internal class DbPatch_001_ContentItemRelatedGuids : IDatabasePatch
{
    public string Name => "001_ContentItemRelatedGuids";
