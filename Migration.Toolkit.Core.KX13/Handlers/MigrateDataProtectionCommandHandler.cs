...
public class MigrateDataProtectionCommandHandler : IRequestHandler<MigrateDataProtectionCommand, CommandResult>, IDisposable
{
    ...
    private readonly IEntityMapper<KX13M.CmsConsentAgreement, CmsConsentAgreement> _consentAgreementMapper;
    private readonly IEntityMapper<KX13M.CmsConsentArchive, CmsConsentArchive> _consentArchiveMapper;
    private readonly IEntityMapper<KX13M.CmsConsent, CmsConsent> _consentMapper;
        ...
        foreach (var kx13Consent in kx13Context.CmsConsents)
        {
            ...
            if (mapped is { Success: true } result)
            {
                ...
                try
                {
                    ...
                    _primaryKeyMappingContext.SetMapping<KX13M.CmsConsent>(r => r.ConsentId, kx13Consent.ConsentId, cmsConsent.ConsentId);
                }
        ...
        foreach (var kx13ArchiveConsent in kx13Context.CmsConsentArchives)
        {
            ...
            if (mapped is { Success: true } result)
            {
                ...
                try
                {
                    ...
                    _primaryKeyMappingContext.SetMapping<KX13M.CmsConsentArchive>(r => r.ConsentArchiveGuid,
