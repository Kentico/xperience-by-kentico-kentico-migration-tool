...
public class MigrateMembersCommandHandler : IRequestHandler<MigrateMembersCommand, CommandResult>, IDisposable
{
    ...
    private async Task<bool> SaveUserUsingKenticoApi(CancellationToken cancellationToken, IModelMappingResult<MemberInfo> mapped, Toolkit.KX13.Models.CmsUser kx13User)
    {
