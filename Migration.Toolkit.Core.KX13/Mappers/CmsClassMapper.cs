...
public class CmsClassMapper : EntityMapperBase<KX13M.CmsClass, DataClassInfo>
{
    ...
    protected override DataClassInfo? CreateNewInstance(Toolkit.KX13.Models.CmsClass source, MappingHelper mappingHelper, AddFailure addFailure) =>
        DataClassInfo.New();

    protected override DataClassInfo MapInternal(Toolkit.KX13.Models.CmsClass source, DataClassInfo target, bool newInstance, MappingHelper mappingHelper,
        AddFailure addFailure)
    {
        ...
        if (mappingHelper.TranslateIdAllowNulls<Toolkit.KX13.Models.CmsResource>(c => c.ResourceId, source.ClassResourceId, out var resourceId))
        {
