...
//
// public class CmsFormMapper : EntityMapperBase<KX13M.CmsForm, BizFormInfo>
// {
...
//     }
//
//     protected override BizFormInfo? CreateNewInstance(Toolkit.KX13.Models.CmsForm source, MappingHelper mappingHelper, AddFailure addFailure)
//     {
...
//     }
//
//     protected override BizFormInfo MapInternal(Toolkit.KX13.Models.CmsForm source, BizFormInfo target, bool newInstance, MappingHelper mappingHelper, AddFailure addFailure)
//     {
...
//
//         if (mappingHelper.TranslateRequiredId<Toolkit.KX13.Models.CmsClass>(c => c.ClassId, source.FormClassId, out var formClassId))
//         {
...
// }
//
// public class CmsFormMapperEf : EntityMapperBase<KX13M.CmsForm, Migration.Toolkit.KXP.Models.CmsForm>
// {
...
//     }
//
//     protected override CmsForm? CreateNewInstance(Toolkit.KX13.Models.CmsForm source, MappingHelper mappingHelper, AddFailure addFailure) => new();
//
//     protected override CmsForm MapInternal(Toolkit.KX13.Models.CmsForm source, CmsForm target, bool newInstance, MappingHelper mappingHelper, AddFailure addFailure)
//     {
//         target.FormDisplayName = source.FormDisplayName;
//         target.FormName = source.FormName;
...
//
//         if (mappingHelper.TranslateRequiredId<Toolkit.KX13.Models.CmsClass>(c => c.ClassId, source.FormClassId, out var classId))
//         {
