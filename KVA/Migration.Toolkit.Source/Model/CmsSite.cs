...
public interface ICmsSite : ISourceModel<ICmsSite>
{
    ...
    static bool ISourceModel<ICmsSite>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsSite ISourceModel<ICmsSite>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
