...
public record CmsSiteK11(
    ...
    int? SiteDefaultStylesheetID,
    string? SiteDefaultVisitorCulture,
    int? SiteDefaultEditorStylesheet,
    Guid SiteGUID,
    DateTime SiteLastModified,
    bool? SiteIsOffline,
    string? SiteOfflineRedirectURL,
    string? SiteOfflineMessage,
    string? SitePresentationURL,
    bool? SiteIsContentOnly) : ICmsSite, ISourceModel<CmsSiteK11>
{
    ...
    static CmsSiteK11 ISourceModel<CmsSiteK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("SiteID"), reader.Unbox<string>("SiteName"), reader.Unbox<string>("SiteDisplayName"), reader.Unbox<string?>("SiteDescription"), reader.Unbox<string>("SiteStatus"), reader.Unbox<string>("SiteDomainName"),
        reader.Unbox<int?>("SiteDefaultStylesheetID"), reader.Unbox<string?>("SiteDefaultVisitorCulture"), reader.Unbox<int?>("SiteDefaultEditorStylesheet"), reader.Unbox<Guid>("SiteGUID"), reader.Unbox<DateTime>("SiteLastModified"),
        reader.Unbox<bool?>("SiteIsOffline"), reader.Unbox<string?>("SiteOfflineRedirectURL"), reader.Unbox<string?>("SiteOfflineMessage"), reader.Unbox<string?>("SitePresentationURL"), reader.Unbox<bool?>("SiteIsContentOnly")
    );
...
public record CmsSiteK12(
    ...
    string? SiteOfflineMessage,
    string? SitePresentationURL,
    bool? SiteIsContentOnly) : ICmsSite, ISourceModel<CmsSiteK12>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "SiteID";
    public static string TableName => "CMS_Site";
...
public record CmsSiteK13(int SiteID, string SiteName, string SiteDisplayName, string? SiteDescription, string SiteStatus, string SiteDomainName, string? SiteDefaultVisitorCulture, Guid SiteGUID, DateTime SiteLastModified, string SitePresentationURL)
    : ICmsSite, ISourceModel<CmsSiteK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "SiteID";
    public static string TableName => "CMS_Site";
    ...
    static CmsSiteK13 ISourceModel<CmsSiteK13>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("SiteID"), reader.Unbox<string>("SiteName"), reader.Unbox<string>("SiteDisplayName"), reader.Unbox<string?>("SiteDescription"), reader.Unbox<string>("SiteStatus"), reader.Unbox<string>("SiteDomainName"),
        reader.Unbox<string?>("SiteDefaultVisitorCulture"), reader.Unbox<Guid>("SiteGUID"), reader.Unbox<DateTime>("SiteLastModified"), reader.Unbox<string>("SitePresentationURL")
    );
