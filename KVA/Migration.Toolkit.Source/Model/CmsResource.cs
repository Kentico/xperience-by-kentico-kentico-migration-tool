...
public record CmsResourceK11(
    int ResourceID,
    string ResourceDisplayName,
    string ResourceName,
    string? ResourceDescription,
    bool? ShowInDevelopment,
    string? ResourceURL,
    Guid ResourceGUID,
    DateTime ResourceLastModified,
    bool? ResourceIsInDevelopment,
    bool? ResourceHasFiles,
    string? ResourceVersion,
    string? ResourceAuthor,
    string? ResourceInstallationState,
    string? ResourceInstalledVersion) : ICmsResource, ISourceModel<CmsResourceK11>
{
    ...
    static CmsResourceK11 ISourceModel<CmsResourceK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("ResourceID"), reader.Unbox<string>("ResourceDisplayName"), reader.Unbox<string>("ResourceName"), reader.Unbox<string?>("ResourceDescription"), reader.Unbox<bool?>("ShowInDevelopment"), reader.Unbox<string?>("ResourceURL"),
        reader.Unbox<Guid>("ResourceGUID"), reader.Unbox<DateTime>("ResourceLastModified"), reader.Unbox<bool?>("ResourceIsInDevelopment"), reader.Unbox<bool?>("ResourceHasFiles"), reader.Unbox<string?>("ResourceVersion"),
        reader.Unbox<string?>("ResourceAuthor"), reader.Unbox<string?>("ResourceInstallationState"), reader.Unbox<string?>("ResourceInstalledVersion")
    );
...
public record CmsResourceK12(
    ...
    string? ResourceAuthor,
    string? ResourceInstallationState,
    string? ResourceInstalledVersion) : ICmsResource, ISourceModel<CmsResourceK12>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "ResourceID";
    public static string TableName => "CMS_Resource";
...
public record CmsResourceK13(
    ...
    string? ResourceAuthor,
    string? ResourceInstallationState,
    string? ResourceInstalledVersion) : ICmsResource, ISourceModel<CmsResourceK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "ResourceID";
    public static string TableName => "CMS_Resource";
