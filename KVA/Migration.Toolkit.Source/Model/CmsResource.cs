...
public interface ICmsResource : ISourceModel<ICmsResource>
{
    ...
    static bool ISourceModel<ICmsResource>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsResource ISourceModel<ICmsResource>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
