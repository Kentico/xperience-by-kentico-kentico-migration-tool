...
public record CmsRelationshipK11(int RelationshipID, int LeftNodeID, int RightNodeID, int RelationshipNameID, string? RelationshipCustomData, int? RelationshipOrder, bool? RelationshipIsAdHoc) : ICmsRelationship, ISourceModel<CmsRelationshipK11>
{
    ...
    static CmsRelationshipK11 ISourceModel<CmsRelationshipK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("RelationshipID"), reader.Unbox<int>("LeftNodeID"), reader.Unbox<int>("RightNodeID"), reader.Unbox<int>("RelationshipNameID"), reader.Unbox<string?>("RelationshipCustomData"), reader.Unbox<int?>("RelationshipOrder"),
        reader.Unbox<bool?>("RelationshipIsAdHoc")
    );
...
public record CmsRelationshipK12(int RelationshipID, int LeftNodeID, int RightNodeID, int RelationshipNameID, string? RelationshipCustomData, int? RelationshipOrder, bool? RelationshipIsAdHoc) : ICmsRelationship, ISourceModel<CmsRelationshipK12>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "RelationshipID";
    public static string TableName => "CMS_Relationship";
...
public record CmsRelationshipK13(int RelationshipID, int LeftNodeID, int RightNodeID, int RelationshipNameID, string? RelationshipCustomData, int? RelationshipOrder, bool? RelationshipIsAdHoc) : ICmsRelationship, ISourceModel<CmsRelationshipK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "RelationshipID";
    public static string TableName => "CMS_Relationship";
