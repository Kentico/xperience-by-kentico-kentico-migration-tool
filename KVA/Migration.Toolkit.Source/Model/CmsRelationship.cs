...
public interface ICmsRelationship : ISourceModel<ICmsRelationship>
{
    ...
    static bool ISourceModel<ICmsRelationship>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsRelationship ISourceModel<ICmsRelationship>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
