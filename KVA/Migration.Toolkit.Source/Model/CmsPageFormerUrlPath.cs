...
public interface ICmsPageFormerUrlPath: ISourceModel<ICmsPageFormerUrlPath>
{
    ...
    static string ISourceModel<ICmsPageFormerUrlPath>.GetPrimaryKeyName(SemanticVersion version)
    {
    ...
    static bool ISourceModel<ICmsPageFormerUrlPath>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsPageFormerUrlPath ISourceModel<ICmsPageFormerUrlPath>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
...
public partial record CmsPageFormerUrlPathK11(): ICmsPageFormerUrlPath, ISourceModel<CmsPageFormerUrlPathK11>
{
    ...
    static CmsPageFormerUrlPathK11 ISourceModel<CmsPageFormerUrlPathK11>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return new CmsPageFormerUrlPathK11(
                            
        );
    }
    public static CmsPageFormerUrlPathK11 FromReader(IDataReader reader, SemanticVersion version)
    {
        return new CmsPageFormerUrlPathK11(
...
public partial record CmsPageFormerUrlPathK12(): ICmsPageFormerUrlPath, ISourceModel<CmsPageFormerUrlPathK12>
{
    public static bool IsAvailable(SemanticVersion version) => false;
    public static string GetPrimaryKeyName(SemanticVersion version) => "";   
    public static string TableName => "CMS_PageFormerUrlPath";
    public static string GuidColumnName => "";
    static CmsPageFormerUrlPathK12 ISourceModel<CmsPageFormerUrlPathK12>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return new CmsPageFormerUrlPathK12(
                            
        );
    }
    public static CmsPageFormerUrlPathK12 FromReader(IDataReader reader, SemanticVersion version)
    {
        return new CmsPageFormerUrlPathK12(
...
public partial record CmsPageFormerUrlPathK13(int PageFormerUrlPathID, string PageFormerUrlPathUrlPath, string PageFormerUrlPathUrlPathHash, string PageFormerUrlPathCulture, int PageFormerUrlPathNodeID, int PageFormerUrlPathSiteID, DateTime PageFormerUrlPathLastModified): ICmsPageFormerUrlPath, ISourceModel<CmsPageFormerUrlPathK13>
{
    ...
    public static string TableName => "CMS_PageFormerUrlPath";
    public static string GuidColumnName => "";
    static CmsPageFormerUrlPathK13 ISourceModel<CmsPageFormerUrlPathK13>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return new CmsPageFormerUrlPathK13(
            reader.Unbox<int>("PageFormerUrlPathID"), reader.Unbox<string>("PageFormerUrlPathUrlPath"), reader.Unbox<string>("PageFormerUrlPathUrlPathHash"), reader.Unbox<string>("PageFormerUrlPathCulture"), reader.Unbox<int>("PageFormerUrlPathNodeID"), reader.Unbox<int>("PageFormerUrlPathSiteID"), reader.Unbox<DateTime>("PageFormerUrlPathLastModified")                
        );
    }
    public static CmsPageFormerUrlPathK13 FromReader(IDataReader reader, SemanticVersion version)
    {
        return new CmsPageFormerUrlPathK13(
            reader.Unbox<int>("PageFormerUrlPathID"), reader.Unbox<string>("PageFormerUrlPathUrlPath"), reader.Unbox<string>("PageFormerUrlPathUrlPathHash"), reader.Unbox<string>("PageFormerUrlPathCulture"), reader.Unbox<int>("PageFormerUrlPathNodeID"), reader.Unbox<int>("PageFormerUrlPathSiteID"), reader.Unbox<DateTime>("PageFormerUrlPathLastModified")                
        );
