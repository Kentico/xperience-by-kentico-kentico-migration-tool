...
public interface ICmsState : ISourceModel<ICmsState>
{
    ...
    static bool ISourceModel<ICmsState>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsState ISourceModel<ICmsState>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
