...
public interface ICmsConsentAgreement: ISourceModel<ICmsConsentAgreement>
{
    ...
    static bool ISourceModel<ICmsConsentAgreement>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsConsentAgreement ISourceModel<ICmsConsentAgreement>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
