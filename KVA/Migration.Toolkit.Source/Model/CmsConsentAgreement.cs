...
public record CmsConsentAgreementK11(int ConsentAgreementID, Guid ConsentAgreementGuid, bool ConsentAgreementRevoked, int ConsentAgreementContactID, int ConsentAgreementConsentID, string? ConsentAgreementConsentHash, DateTime ConsentAgreementTime)
    : ICmsConsentAgreement, ISourceModel<CmsConsentAgreementK11>
{
    ...
    static CmsConsentAgreementK11 ISourceModel<CmsConsentAgreementK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("ConsentAgreementID"), reader.Unbox<Guid>("ConsentAgreementGuid"), reader.Unbox<bool>("ConsentAgreementRevoked"), reader.Unbox<int>("ConsentAgreementContactID"), reader.Unbox<int>("ConsentAgreementConsentID"),
        reader.Unbox<string?>("ConsentAgreementConsentHash"), reader.Unbox<DateTime>("ConsentAgreementTime")
    );
...
public record CmsConsentAgreementK12(int ConsentAgreementID, Guid ConsentAgreementGuid, bool ConsentAgreementRevoked, int ConsentAgreementContactID, int ConsentAgreementConsentID, string? ConsentAgreementConsentHash, DateTime ConsentAgreementTime)
    : ICmsConsentAgreement, ISourceModel<CmsConsentAgreementK12>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "ConsentAgreementID";
    public static string TableName => "CMS_ConsentAgreement";
...
public record CmsConsentAgreementK13(int ConsentAgreementID, Guid ConsentAgreementGuid, bool ConsentAgreementRevoked, int ConsentAgreementContactID, int ConsentAgreementConsentID, string? ConsentAgreementConsentHash, DateTime ConsentAgreementTime)
    : ICmsConsentAgreement, ISourceModel<CmsConsentAgreementK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "ConsentAgreementID";
    public static string TableName => "CMS_ConsentAgreement";
