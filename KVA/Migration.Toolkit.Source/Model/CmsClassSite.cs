...
public interface ICmsClassSite: ISourceModel<ICmsClassSite>
{
    ...
    static bool ISourceModel<ICmsClassSite>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsClassSite ISourceModel<ICmsClassSite>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
