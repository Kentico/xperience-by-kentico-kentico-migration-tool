...
public record CmsAlternativeFormK11(
    int FormID,
    ...
    int? FormCoupledClassID,
    bool? FormHideNewParentFields,
    string? FormLayoutType,
    string? FormVersionGUID,
    string? FormCustomizedColumns,
    bool? FormIsCustom) : ICmsAlternativeForm, ISourceModel<CmsAlternativeFormK11>
{
    ...
    static CmsAlternativeFormK11 ISourceModel<CmsAlternativeFormK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("FormID"), reader.Unbox<string>("FormDisplayName"), reader.Unbox<string>("FormName"), reader.Unbox<int>("FormClassID"), reader.Unbox<string?>("FormDefinition"), reader.Unbox<string?>("FormLayout"),
        reader.Unbox<Guid>("FormGUID"), reader.Unbox<DateTime>("FormLastModified"), reader.Unbox<int?>("FormCoupledClassID"), reader.Unbox<bool?>("FormHideNewParentFields"), reader.Unbox<string?>("FormLayoutType"),
...
public record CmsAlternativeFormK12(
    int FormID,
    string FormDisplayName,
    string FormName,
    int FormClassID,
    ...
    string? FormVersionGUID,
    string? FormCustomizedColumns,
    bool? FormIsCustom) : ICmsAlternativeForm, ISourceModel<CmsAlternativeFormK12>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "FormID";
    public static string TableName => "CMS_AlternativeForm";
...
public record CmsAlternativeFormK13(
    ...
    string? FormVersionGUID,
    string? FormCustomizedColumns,
    bool? FormIsCustom) : ICmsAlternativeForm, ISourceModel<CmsAlternativeFormK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "FormID";
    public static string TableName => "CMS_AlternativeForm";
