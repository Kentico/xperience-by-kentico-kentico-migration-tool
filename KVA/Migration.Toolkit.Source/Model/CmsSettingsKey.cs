...
public interface ICmsSettingsKey : ISourceModel<ICmsSettingsKey>
{
    ...
    static bool ISourceModel<ICmsSettingsKey>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsSettingsKey ISourceModel<ICmsSettingsKey>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
