...
public partial record CmsDocumentCategoryK11(int DocumentID, int CategoryID) : ICmsDocumentCategory, ISourceModel<CmsDocumentCategoryK11>
{
    ...
    static CmsDocumentCategoryK11 ISourceModel<CmsDocumentCategoryK11>.FromReader(IDataReader reader, SemanticVersion version) => new CmsDocumentCategoryK11(
            reader.Unbox<int>("DocumentID"), reader.Unbox<int>("CategoryID")
        );
    public static CmsDocumentCategoryK11 FromReader(IDataReader reader, SemanticVersion version) => new CmsDocumentCategoryK11(
            reader.Unbox<int>("DocumentID"), reader.Unbox<int>("CategoryID")
        );
};
public partial record CmsDocumentCategoryK12(int DocumentID, int CategoryID) : ICmsDocumentCategory, ISourceModel<CmsDocumentCategoryK12>
{
    ...
    public static string TableName => "CMS_DocumentCategory";
    public static string GuidColumnName => "";
    static CmsDocumentCategoryK12 ISourceModel<CmsDocumentCategoryK12>.FromReader(IDataReader reader, SemanticVersion version) => new CmsDocumentCategoryK12(
            reader.Unbox<int>("DocumentID"), reader.Unbox<int>("CategoryID")
        );
    public static CmsDocumentCategoryK12 FromReader(IDataReader reader, SemanticVersion version) => new CmsDocumentCategoryK12(
            reader.Unbox<int>("DocumentID"), reader.Unbox<int>("CategoryID")
        );
};
public partial record CmsDocumentCategoryK13(int DocumentID, int CategoryID) : ICmsDocumentCategory, ISourceModel<CmsDocumentCategoryK13>
{
    ...
    public static string TableName => "CMS_DocumentCategory";
    public static string GuidColumnName => "";
    static CmsDocumentCategoryK13 ISourceModel<CmsDocumentCategoryK13>.FromReader(IDataReader reader, SemanticVersion version) => new CmsDocumentCategoryK13(
            reader.Unbox<int>("DocumentID"), reader.Unbox<int>("CategoryID")
        );
    public static CmsDocumentCategoryK13 FromReader(IDataReader reader, SemanticVersion version) => new CmsDocumentCategoryK13(
            reader.Unbox<int>("DocumentID"), reader.Unbox<int>("CategoryID")
        );
};
