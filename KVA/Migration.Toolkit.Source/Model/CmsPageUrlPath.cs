...
{
    static string ISourceModel<ICmsPageUrlPath>.GetPrimaryKeyName(SemanticVersion version) => version switch
    {
    ...
    static bool ISourceModel<ICmsPageUrlPath>.IsAvailable(SemanticVersion version) => version switch
    {
    ...
    static ICmsPageUrlPath ISourceModel<ICmsPageUrlPath>.FromReader(IDataReader reader, SemanticVersion version) => version switch
    {
...
public record CmsPageUrlPathK11 : ICmsPageUrlPath, ISourceModel<CmsPageUrlPathK11>
{
    ...
    static CmsPageUrlPathK11 ISourceModel<CmsPageUrlPathK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
    );

    public static CmsPageUrlPathK11 FromReader(IDataReader reader, SemanticVersion version) => new(
    );
}

public record CmsPageUrlPathK12 : ICmsPageUrlPath, ISourceModel<CmsPageUrlPathK12>
{
    public static bool IsAvailable(SemanticVersion version) => false;
    public static string GetPrimaryKeyName(SemanticVersion version) => "";
    public static string TableName => "CMS_PageUrlPath";
    ...
    static CmsPageUrlPathK12 ISourceModel<CmsPageUrlPathK12>.FromReader(IDataReader reader, SemanticVersion version) => new(
    );

    public static CmsPageUrlPathK12 FromReader(IDataReader reader, SemanticVersion version) => new(
    );
}

public record CmsPageUrlPathK13(int PageUrlPathID, Guid PageUrlPathGUID, string PageUrlPathCulture, int PageUrlPathNodeID, string PageUrlPathUrlPath, string PageUrlPathUrlPathHash, int PageUrlPathSiteID, DateTime PageUrlPathLastModified)
    : ICmsPageUrlPath, ISourceModel<CmsPageUrlPathK13>
{
    ...
    static CmsPageUrlPathK13 ISourceModel<CmsPageUrlPathK13>.FromReader(IDataReader reader, SemanticVersion version) => new(
    ...
    public static CmsPageUrlPathK13 FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("PageUrlPathID"), reader.Unbox<Guid>("PageUrlPathGUID"), reader.Unbox<string>("PageUrlPathCulture"), reader.Unbox<int>("PageUrlPathNodeID"), reader.Unbox<string>("PageUrlPathUrlPath"),
        reader.Unbox<string>("PageUrlPathUrlPathHash"), reader.Unbox<int>("PageUrlPathSiteID"), reader.Unbox<DateTime>("PageUrlPathLastModified")
    );
}
