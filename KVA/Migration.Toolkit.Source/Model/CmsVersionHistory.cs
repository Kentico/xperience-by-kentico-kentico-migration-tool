...
public interface ICmsVersionHistory : ISourceModel<ICmsVersionHistory>
{
...
public record CmsVersionHistoryK11(
    ...
    DateTime? PublishTo,
    DateTime? WasPublishedFrom,
    DateTime? WasPublishedTo,
    string? VersionDocumentName,
    string? VersionDocumentType,
    int? VersionClassID,
    string? VersionMenuRedirectUrl,
    int? VersionWorkflowID,
    int? VersionWorkflowStepID,
    string? VersionNodeAliasPath,
    int? VersionDeletedByUserID,
    DateTime? VersionDeletedWhen) : ICmsVersionHistory, ISourceModel<CmsVersionHistoryK11>
{
    ...
    static CmsVersionHistoryK11 ISourceModel<CmsVersionHistoryK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("VersionHistoryID"), reader.Unbox<int>("NodeSiteID"), reader.Unbox<int?>("DocumentID"), reader.Unbox<string>("DocumentNamePath"), reader.Unbox<string>("NodeXML"), reader.Unbox<int?>("ModifiedByUserID"),
        reader.Unbox<DateTime>("ModifiedWhen"), reader.Unbox<string?>("VersionNumber"), reader.Unbox<string?>("VersionComment"), reader.Unbox<bool>("ToBePublished"), reader.Unbox<DateTime?>("PublishFrom"), reader.Unbox<DateTime?>("PublishTo"),
        reader.Unbox<DateTime?>("WasPublishedFrom"), reader.Unbox<DateTime?>("WasPublishedTo"), reader.Unbox<string?>("VersionDocumentName"), reader.Unbox<string?>("VersionDocumentType"), reader.Unbox<int?>("VersionClassID"),
        reader.Unbox<string?>("VersionMenuRedirectUrl"), reader.Unbox<int?>("VersionWorkflowID"), reader.Unbox<int?>("VersionWorkflowStepID"), reader.Unbox<string?>("VersionNodeAliasPath"), reader.Unbox<int?>("VersionDeletedByUserID"),
        reader.Unbox<DateTime?>("VersionDeletedWhen")
    );
...
public record CmsVersionHistoryK12(
    int VersionHistoryID,
    int NodeSiteID,
    int? DocumentID,
    string DocumentNamePath,
    ...
    string? VersionNodeAliasPath,
    int? VersionDeletedByUserID,
    DateTime? VersionDeletedWhen) : ICmsVersionHistory, ISourceModel<CmsVersionHistoryK12>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "VersionHistoryID";
    public static string TableName => "CMS_VersionHistory";
...
public record CmsVersionHistoryK13(
    int VersionHistoryID,
    int NodeSiteID,
    int? DocumentID,
    string NodeXML,
    ...
    string? VersionNodeAliasPath,
    int? VersionDeletedByUserID,
    DateTime? VersionDeletedWhen) : ICmsVersionHistory, ISourceModel<CmsVersionHistoryK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "VersionHistoryID";
    public static string TableName => "CMS_VersionHistory";
    ...
    static CmsVersionHistoryK13 ISourceModel<CmsVersionHistoryK13>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("VersionHistoryID"), reader.Unbox<int>("NodeSiteID"), reader.Unbox<int?>("DocumentID"), reader.Unbox<string>("NodeXML"), reader.Unbox<int?>("ModifiedByUserID"), reader.Unbox<DateTime>("ModifiedWhen"),
        reader.Unbox<string?>("VersionNumber"), reader.Unbox<string?>("VersionComment"), reader.Unbox<bool>("ToBePublished"), reader.Unbox<DateTime?>("PublishFrom"), reader.Unbox<DateTime?>("PublishTo"), reader.Unbox<DateTime?>("WasPublishedFrom"),
        reader.Unbox<DateTime?>("WasPublishedTo"), reader.Unbox<string?>("VersionDocumentName"), reader.Unbox<int?>("VersionClassID"), reader.Unbox<int?>("VersionWorkflowID"), reader.Unbox<int?>("VersionWorkflowStepID"),
        reader.Unbox<string?>("VersionNodeAliasPath"), reader.Unbox<int?>("VersionDeletedByUserID"), reader.Unbox<DateTime?>("VersionDeletedWhen")
    );
