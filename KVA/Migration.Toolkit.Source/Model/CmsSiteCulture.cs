...
public interface ICmsSiteCulture : ISourceModel<ICmsSiteCulture>
{
    ...
    static bool ISourceModel<ICmsSiteCulture>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsSiteCulture ISourceModel<ICmsSiteCulture>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
