...
public record CmsPageTemplateConfigurationK11 : ICmsPageTemplateConfiguration, ISourceModel<CmsPageTemplateConfigurationK11>
{
    ...
    static CmsPageTemplateConfigurationK11 ISourceModel<CmsPageTemplateConfigurationK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
    );

    public static CmsPageTemplateConfigurationK11 FromReader(IDataReader reader, SemanticVersion version) => new(
    );
}

public partial record CmsPageTemplateConfigurationK12(
    int PageTemplateConfigurationID,
    Guid PageTemplateConfigurationGUID,
    int PageTemplateConfigurationSiteID,
    DateTime PageTemplateConfigurationLastModified,
    string PageTemplateConfigurationName,
    string? PageTemplateConfigurationDescription,
    Guid? PageTemplateConfigurationThumbnailGUID,
    string PageTemplateConfigurationTemplate,
    string? PageTemplateConfigurationWidgets) : ICmsPageTemplateConfiguration, ISourceModel<CmsPageTemplateConfigurationK12>
{
    ...
    static CmsPageTemplateConfigurationK12 ISourceModel<CmsPageTemplateConfigurationK12>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("PageTemplateConfigurationID"), reader.Unbox<Guid>("PageTemplateConfigurationGUID"), reader.Unbox<int>("PageTemplateConfigurationSiteID"), reader.Unbox<DateTime>("PageTemplateConfigurationLastModified"),
        reader.Unbox<string>("PageTemplateConfigurationName"), reader.Unbox<string?>("PageTemplateConfigurationDescription"), reader.Unbox<Guid?>("PageTemplateConfigurationThumbnailGUID"), reader.Unbox<string>("PageTemplateConfigurationTemplate"),
        reader.Unbox<string?>("PageTemplateConfigurationWidgets")
    );

    public static CmsPageTemplateConfigurationK12 FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("PageTemplateConfigurationID"), reader.Unbox<Guid>("PageTemplateConfigurationGUID"), reader.Unbox<int>("PageTemplateConfigurationSiteID"), reader.Unbox<DateTime>("PageTemplateConfigurationLastModified"),
        reader.Unbox<string>("PageTemplateConfigurationName"), reader.Unbox<string?>("PageTemplateConfigurationDescription"), reader.Unbox<Guid?>("PageTemplateConfigurationThumbnailGUID"), reader.Unbox<string>("PageTemplateConfigurationTemplate"),
        reader.Unbox<string?>("PageTemplateConfigurationWidgets")
    );
...
public partial record CmsPageTemplateConfigurationK13(
    int PageTemplateConfigurationID,
    Guid PageTemplateConfigurationGUID,
    int PageTemplateConfigurationSiteID,
    DateTime PageTemplateConfigurationLastModified,
    ...
    Guid? PageTemplateConfigurationThumbnailGUID,
    string PageTemplateConfigurationTemplate,
    string? PageTemplateConfigurationWidgets) : ICmsPageTemplateConfiguration, ISourceModel<CmsPageTemplateConfigurationK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "PageTemplateConfigurationID";
    public static string TableName => "CMS_PageTemplateConfiguration";
    ...
    static CmsPageTemplateConfigurationK13 ISourceModel<CmsPageTemplateConfigurationK13>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("PageTemplateConfigurationID"), reader.Unbox<Guid>("PageTemplateConfigurationGUID"), reader.Unbox<int>("PageTemplateConfigurationSiteID"), reader.Unbox<DateTime>("PageTemplateConfigurationLastModified"),
        reader.Unbox<string>("PageTemplateConfigurationName"), reader.Unbox<string?>("PageTemplateConfigurationDescription"), reader.Unbox<Guid?>("PageTemplateConfigurationThumbnailGUID"), reader.Unbox<string>("PageTemplateConfigurationTemplate"),
        reader.Unbox<string?>("PageTemplateConfigurationWidgets")
    );

    public static CmsPageTemplateConfigurationK13 FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("PageTemplateConfigurationID"), reader.Unbox<Guid>("PageTemplateConfigurationGUID"), reader.Unbox<int>("PageTemplateConfigurationSiteID"), reader.Unbox<DateTime>("PageTemplateConfigurationLastModified"),
        reader.Unbox<string>("PageTemplateConfigurationName"), reader.Unbox<string?>("PageTemplateConfigurationDescription"), reader.Unbox<Guid?>("PageTemplateConfigurationThumbnailGUID"), reader.Unbox<string>("PageTemplateConfigurationTemplate"),
        reader.Unbox<string?>("PageTemplateConfigurationWidgets")
    );
