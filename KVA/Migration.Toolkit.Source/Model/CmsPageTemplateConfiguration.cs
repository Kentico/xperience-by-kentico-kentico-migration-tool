...
public interface ICmsPageTemplateConfiguration : ISourceModel<ICmsPageTemplateConfiguration>
{
    ...
    static bool ISourceModel<ICmsPageTemplateConfiguration>.IsAvailable(SemanticVersion version)
    {
        return version switch
        {
    ...
    static ICmsPageTemplateConfiguration ISourceModel<ICmsPageTemplateConfiguration>.FromReader(IDataReader reader, SemanticVersion version)
    {
        return version switch
        {
