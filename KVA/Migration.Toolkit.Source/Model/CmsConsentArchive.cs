...
public interface ICmsConsentArchive : ISourceModel<ICmsConsentArchive>
{
...
public record CmsConsentArchiveK11(int ConsentArchiveID, Guid ConsentArchiveGuid, DateTime ConsentArchiveLastModified, int ConsentArchiveConsentID, string ConsentArchiveHash, string ConsentArchiveContent)
    : ICmsConsentArchive, ISourceModel<CmsConsentArchiveK11>
{
    ...
    static CmsConsentArchiveK11 ISourceModel<CmsConsentArchiveK11>.FromReader(IDataReader reader, SemanticVersion version) => new(
        reader.Unbox<int>("ConsentArchiveID"), reader.Unbox<Guid>("ConsentArchiveGuid"), reader.Unbox<DateTime>("ConsentArchiveLastModified"), reader.Unbox<int>("ConsentArchiveConsentID"), reader.Unbox<string>("ConsentArchiveHash"),
        reader.Unbox<string>("ConsentArchiveContent")
    );
...
public record CmsConsentArchiveK12(int ConsentArchiveID, Guid ConsentArchiveGuid, DateTime ConsentArchiveLastModified, int ConsentArchiveConsentID, string ConsentArchiveHash, string ConsentArchiveContent)
    : ICmsConsentArchive, ISourceModel<CmsConsentArchiveK12>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "ConsentArchiveID";
    public static string TableName => "CMS_ConsentArchive";
...
public record CmsConsentArchiveK13(int ConsentArchiveID, Guid ConsentArchiveGuid, DateTime ConsentArchiveLastModified, int ConsentArchiveConsentID, string ConsentArchiveHash, string ConsentArchiveContent)
    : ICmsConsentArchive, ISourceModel<CmsConsentArchiveK13>
{
    public static bool IsAvailable(SemanticVersion version) => true;
    public static string GetPrimaryKeyName(SemanticVersion version) => "ConsentArchiveID";
    public static string TableName => "CMS_ConsentArchive";
