    ...
    : IRequestHandler<MigrateSettingKeysCommand, CommandResult>
{
    ...
    {
        var entityConfiguration = toolConfiguration.EntityConfigurations.GetEntityConfiguration<KX12M.CmsSettingsKey>();
    ...
    private SettingsKeyInfo? GetKxoSettingsKey(KX12M.CmsSettingsKey k12CmsSettingsKey) => SettingsKeyInfo.Provider.Get(k12CmsSettingsKey.KeyName);
}
