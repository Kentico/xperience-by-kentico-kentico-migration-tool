namespace DancingGoat.Controllers
{
    ...
    public class ToolkitApi: Controller
    {
        ...
        public ToolkitApi(IHttpContextAccessor httpContextAccessor)
        {
        ...
        [HttpPost("/ToolkitGetAllDefinitions/ping")]
        public async Task<IActionResult> Ping([FromBody] BodyModel body)
        {
        ...
        [HttpPost("/ToolkitGetAllDefinitions")]
        ...
        [HttpPost("/ToolkitGetAllFormComponents")]
