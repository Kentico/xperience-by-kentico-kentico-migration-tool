    ...
    where TResponse : CommandResult
{
    ...
    private bool CheckVersion(KX12Context KX12Context, SemanticVersion minimalVersion)
    {
        ...
        if (KX12Context.CmsSettingsKeys.FirstOrDefault(s => s.KeyName == CmsDataVersionKey) is { } cmsDataVersion)
        {
        ...
        if (KX12Context.CmsSettingsKeys.FirstOrDefault(s => s.KeyName == CmsDbVersionKey) is { } cmsDbVersion)
        {
        ...
        if (KX12Context.CmsSettingsKeys.FirstOrDefault(s => s.KeyName == CmsHotfixDataVersionKey) is { } cmsHotfixDataVersion)
        {
        ...
        if (KX12Context.CmsSettingsKeys.FirstOrDefault(s => s.KeyName == CmsHotfixVersionKey) is { } cmsHotfixVersion)
        {
