...
public class MemberInfoMapper : EntityMapperBase<MemberInfoMapperSource, MemberInfo>
{
    ...
    private readonly IDbContextFactory<KX12Context> _kx13DbContextFactory;
    ...
    public MemberInfoMapper(
        ...
        IDbContextFactory<KX12Context> kx13DbContextFactory
    ...
    protected override MemberInfo MapInternal(MemberInfoMapperSource source, MemberInfo target, bool newInstance, MappingHelper mappingHelper, AddFailure addFailure)
    {
        ...
        using var kx12Context = _kx13DbContextFactory.CreateDbContext();
        var usDci = kx12Context.CmsClasses.Select(x => new { x.ClassFormDefinition, x.ClassName, x.ClassTableName }).FirstOrDefault(x => x.ClassName == Kx13SystemClass.cms_usersettings);
