...
public class ResourceMapper : EntityMapperBase<KX12M.CmsResource, ResourceInfo>
{
    ...
    protected override ResourceInfo? CreateNewInstance(KX12M.CmsResource source, MappingHelper mappingHelper, AddFailure addFailure)
        => ResourceInfo.New();

    protected override ResourceInfo MapInternal(KX12M.CmsResource source, ResourceInfo target, bool newInstance, MappingHelper mappingHelper, AddFailure addFailure)
    {
