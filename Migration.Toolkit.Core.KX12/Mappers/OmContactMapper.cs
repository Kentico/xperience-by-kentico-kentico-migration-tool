...
public class OmContactMapper : EntityMapperBase<KX12M.OmContact, OmContact>
{
    ...
    private readonly IEntityMapper<KX12M.OmContactStatus, OmContactStatus> _contactStatusMapper;
    ...
    protected override OmContact? CreateNewInstance(KX12M.OmContact tSourceEntity, MappingHelper mappingHelper, AddFailure addFailure) => new();

    protected override OmContact MapInternal(KX12M.OmContact source, OmContact target, bool newInstance, MappingHelper mappingHelper, AddFailure addFailure)
    {
