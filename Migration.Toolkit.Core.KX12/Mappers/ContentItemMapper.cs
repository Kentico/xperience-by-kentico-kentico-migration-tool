...
public class ContentItemMapper : UmtMapperBase<CmsTreeMapperSource>
{
    ...
    private IEnumerable<IUmtModel> MigrateDraft(KX12M.CmsVersionHistory checkoutVersion, KX12M.CmsTree cmsTree, string sourceFormClassDefinition, string targetFormDefinition, Guid contentItemGuid, Guid contentLanguageGuid)
    {
