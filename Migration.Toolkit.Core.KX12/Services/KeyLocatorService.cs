...
public class KeyLocatorService
{
    ...
    public KeyLocatorService(
        ...
        IDbContextFactory<KX12.Context.KX12Context> kx12ContextFactory
    )
    {
        _logger = logger;
    ...
    ) where TSource : class where TTarget: class
    {
        ...
        try
        {
            ...
            var kx13Guid = kx12Context.Set<TSource>().Where(sourcePredicate).Select(sourceGuidSelector).Single();
