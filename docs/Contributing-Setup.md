...
Please provide all available information about the problem or error when submitting issues. If possible, include the command line output log file generated by the `Migration.Tool.CLI.exe migrate` command.
