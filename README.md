...
![Migration Flow Diagram](./images/diagrams/migration-flow.drawio)

**Diagram Description:** The migration follows six sequential steps:
...
- **Source instance** (K11/KX12/KX13) running and accessible
  - KX13 must be **Refresh 5 or higher**
...
The migration tool handles standard data transformations automatically. Custom implementations require additional configuration when migrating:

- **Custom field types** with specialized data transformations
- **Page Builder widgets** with property mapping adjustments
- **Custom modules or tables** with specific handling logic
...
## Technical Documentation (This Repository) - TODO: to be updated when final
...
When [creating an issue](https://github.com/Kentico/xperience-by-kentico-kentico-migration-tool/issues/new), provide all available information about the problem or error. Include the command line output log file and migration protocol generated by the `Migration.Tool.CLI.exe migrate` command when possible.
