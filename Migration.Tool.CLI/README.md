...
| `--type-restrictions`       | Enables migration of [content type restrictions](https://docs.kentico.com/13/developing-websites/defining-website-content-structure/managing-page-types/limiting-the-pages-users-can-create).                                                                                                                                                                                           | `--sites`, `--pagetypes`, `--pages`            |
