...
| TargetWorkspaceName                                               | Name (not display name) of fallback workspace for migrated folders, content items and other entities. The fallback is used if not explicitly specified otherwise, e.g. by content item director. If there is only one workspace in target database, this value is not necessary.                                                                                                                                                                                                                                                                           |
