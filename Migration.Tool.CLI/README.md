...
| ConvertClassesToContentHub                                         | Specifies which page types or custom tables are migrated to [reusable content items](https://docs.kentico.com/x/content_items_xp) (instead of website channel pages or custom module classes for custom tables). Enter page type code names, separated with either `;` or `,`. See [Convert pages or custom tables to Content hub](#convert-pages-or-custom-tables-to-content-hub) and [Convert pages or custom tables to Content hub](#convert-pages-or-custom-tables-to-content-hub) for detailed information.                                                                                                                                                                                                                                                                                                                                      |
