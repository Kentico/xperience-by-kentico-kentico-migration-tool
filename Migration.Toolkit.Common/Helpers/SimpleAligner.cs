...
{
    public static Aligner<TA, TB, TKey> CreateAligner<TA, TB, TKey>(IEnumerator<TA> eA, IEnumerator<TB> eB, IEnumerator<TKey> eK,
        ...
        where TA : class where TB : class => new(eA, eB, eK, selectKeyA, selectKeyB, disposeEnumerators);
