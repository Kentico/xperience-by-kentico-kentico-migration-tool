...
public class K12SystemResource
{
    ...
    [
        ...
        CMS_Badwords,
        CMS_BannedIP,
        CMS_BannerManagement,
        CMS_Blog,
        CMS_Categories,
        CMS_Chat,
        CMS_Community,
        CMS_ContactManagement,
        CMS_Content,
        CMS_ContentPersonalization,
        CMS_ContinuousIntegration,
        cms_customsystemmodule,
        CMS_CustomTables,
        CMS_DancingGoat_Samples,
        CMS_DataProtection,
        CMS_Design,
        CMS_DeviceProfiles,
        CMS_DocumentEngine,
        ...
        CMS_SocialMarketing,
        CMS_Staging,
        CMS_StrandsRecommender,
        CMS_Synchronization,
        CMS_Taxonomy,
        CMS_TranslationServices,
        CMS_UIPersonalization,
        CMS_Users,
        CMS_WebAnalytics,
        CMS_WebFarm,
        CMS_Widgets,
