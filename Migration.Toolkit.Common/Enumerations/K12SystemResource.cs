...
public class K12SystemResource
{
    ...
    public const string CMS_Badwords = "CMS.Badwords";
    public const string CMS_BannedIP = "CMS.BannedIP";
    public const string CMS_BannerManagement = "CMS.BannerManagement";
    public const string CMS_Blog = "CMS.Blog";
    public const string CMS_Categories = "CMS.Categories";
    public const string CMS_Chat = "CMS.Chat";
    public const string CMS_Community = "CMS.Community";
    public const string CMS_ContactManagement = "CMS.ContactManagement";
    public const string CMS_Content = "CMS.Content";
    public const string CMS_ContentPersonalization = "CMS.ContentPersonalization";
    ...
    public const string CMS_DancingGoat_Samples = "CMS.DancingGoat.Samples";
    public const string CMS_DataProtection = "CMS.DataProtection";
    public const string CMS_Design = "CMS.Design";
    public const string CMS_DeviceProfiles = "CMS.DeviceProfiles";
    ...
    public const string CMS_MessageBoards = "CMS.MessageBoards";
    ...
    public const string CMS_StrandsRecommender = "CMS.StrandsRecommender";
    ...
    [
        CMS, CMS_ABTest, CMS_AbuseReport, CMS_Activities, CMS_Badges, CMS_Badwords, CMS_BannedIP, CMS_BannerManagement, CMS_Blog, CMS_Categories, CMS_Chat, CMS_Community, CMS_ContactManagement,
        CMS_Content, CMS_ContentPersonalization, CMS_ContinuousIntegration, cms_customsystemmodule, CMS_CustomTables, CMS_DancingGoat_Samples, CMS_DataProtection, CMS_Design, CMS_DeviceProfiles,
        CMS_DocumentEngine, CMS_Ecommerce, CMS_EmailEngine, CMS_EmailTemplates, CMS_EventLog, CMS_EventManager, CMS_Form, CMS_Forums, CMS_Globalization, CMS_GlobalPermissions, CMS_Groups,
        CMS_Localization, CMS_MacroEngine, CMS_MediaDialog, CMS_MediaLibrary, CMS_Membership, CMS_MessageBoards, CMS_ModuleLicenses, CMS_ModuleUsageTracking, CMS_MVTest, CMS_Newsletter,
        CMS_Notifications, CMS_OnlineMarketing, CMS_OnSiteEdit, CMS_Permissions, CMS_Personas, CMS_Polls, CMS_Relationships, CMS_Reporting, CMS_Roles, CMS_ScheduledTasks, CMS_Scoring, CMS_Search,
        CMS_Search_Azure, CMS_SharePoint, CMS_SocialMarketing, CMS_Staging, CMS_StrandsRecommender, CMS_Synchronization, CMS_Taxonomy, CMS_TranslationServices, CMS_UIPersonalization, CMS_Users,
        CMS_WebAnalytics, CMS_WebFarm, CMS_Widgets, CMS_WIFIntegration, CMS_WorkflowEngine, CMS_WYSIWYGEditor, Licenses
    ];
