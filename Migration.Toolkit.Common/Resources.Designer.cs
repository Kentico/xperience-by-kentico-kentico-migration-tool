...
namespace Migration.Toolkit.Common {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Configuration value in path &apos;Settings.TargetAttachmentMediaLibraryName&apos; is required..
        /// </summary>
        public static string ConfigurationValidator_GetValidationErrors_TargetAttachmentMediaLibraryName_IsRequired {
            get {
                return ResourceManager.GetString("ConfigurationValidator_GetValidationErrors_TargetAttachmentMediaLibraryName_IsReq" +
                        "uired", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Set value to &apos;CmsAttachmentsForSite{{siteName}}Or{{siteId}}&apos; for example. Command &apos;--attachments&apos; cannot complete successfully without value set..
        /// </summary>
        public static string ConfigurationValidator_GetValidationErrors_TargetAttachmentMediaLibraryName_RecommendedFix {
            get {
                return ResourceManager.GetString("ConfigurationValidator_GetValidationErrors_TargetAttachmentMediaLibraryName_Recom" +
                        "mendedFix", resourceCulture);
            }
        }
