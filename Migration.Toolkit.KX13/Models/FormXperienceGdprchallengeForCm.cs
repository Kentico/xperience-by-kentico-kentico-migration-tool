...
{
    [Table("Form_Xperience_GDPRChallengeForCMS")]
    public partial class FormXperienceGdprchallengeForCm
    {
        [Key]
        [Column("Resource_GDPRChallengeForCMSID")]
        public int ResourceGdprchallengeForCmsid { get; set; }
