...
{
    [Table("Form_Xperience_FutureCMOReport_2")]
    public partial class FormXperienceFutureCmoreport2
    {
        [Key]
        [Column("Resource_FutureCMOReportPart2ID")]
        public int ResourceFutureCmoreportPart2Id { get; set; }
