...
{
    [Table("Form_Xperience_OrderPayByCheck")]
    public partial class FormXperienceOrderPayByCheck
    {
        [Key]
        [Column("OrderPayByCheck_xpID")]
        public int OrderPayByCheckXpId { get; set; }
