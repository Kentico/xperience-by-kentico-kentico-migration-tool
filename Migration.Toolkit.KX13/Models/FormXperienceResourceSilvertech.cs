...
{
    [Table("Form_Xperience_Resource_Silvertech")]
    public partial class FormXperienceResourceSilvertech
    {
        [Key]
        [Column("Resource_SilvertechID")]
        public int ResourceSilvertechId { get; set; }
