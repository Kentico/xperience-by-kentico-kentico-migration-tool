...
{
    [Table("Form_Connection_Connection2022APAC")]
    public partial class FormConnectionConnection2022Apac
    {
        [Key]
        [Column("Connection2022APACID")]
        public int Connection2022Apacid { get; set; }
