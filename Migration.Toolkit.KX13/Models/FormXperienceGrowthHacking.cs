...
{
    [Table("Form_Xperience_GrowthHacking")]
    public partial class FormXperienceGrowthHacking
    {
        [Key]
        [Column("Resource_GrowthHackingID")]
        public int ResourceGrowthHackingId { get; set; }
