...
{
    [Table("Form_Xperience_FutureCMOReport")]
    public partial class FormXperienceFutureCmoreport
    {
        [Key]
        [Column("Resource_FutureCMOReportID")]
        public int ResourceFutureCmoreportId { get; set; }
