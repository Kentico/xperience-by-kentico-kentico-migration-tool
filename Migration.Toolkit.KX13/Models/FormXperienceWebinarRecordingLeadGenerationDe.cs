...
{
    [Table("Form_Xperience_WebinarRecording_LeadGeneration_DE")]
    public partial class FormXperienceWebinarRecordingLeadGenerationDe
    {
        [Key]
        [Column("WebinarRecording_LeadGeneration_DEID")]
        public int WebinarRecordingLeadGenerationDeid { get; set; }
