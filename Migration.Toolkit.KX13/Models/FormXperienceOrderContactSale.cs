...
{
    [Table("Form_Xperience_OrderContactSales")]
    public partial class FormXperienceOrderContactSale
    {
        [Key]
        [Column("OrderContactSales_xpID")]
        public int OrderContactSalesXpId { get; set; }
