...
{
    [Table("Form_Xperience_TrainingContactSales")]
    public partial class FormXperienceTrainingContactSale
    {
        [Key]
        [Column("TrainingContactSales_xpID")]
        public int TrainingContactSalesXpId { get; set; }
