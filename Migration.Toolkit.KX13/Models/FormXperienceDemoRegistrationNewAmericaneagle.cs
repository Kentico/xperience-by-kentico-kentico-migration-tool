...
{
    [Table("Form_Xperience_DemoRegistrationNew_americaneagle")]
    public partial class FormXperienceDemoRegistrationNewAmericaneagle
    {
        [Key]
        [Column("DemoRegistrationNew_americaneagleID")]
        public int DemoRegistrationNewAmericaneagleId { get; set; }
