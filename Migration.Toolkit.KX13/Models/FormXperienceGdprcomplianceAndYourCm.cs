...
{
    [Table("Form_Xperience_GDPRComplianceAndYourCMS")]
    public partial class FormXperienceGdprcomplianceAndYourCm
    {
        [Key]
        [Column("Resource_GDPRComplianceAndYourCMSID")]
        public int ResourceGdprcomplianceAndYourCmsid { get; set; }
