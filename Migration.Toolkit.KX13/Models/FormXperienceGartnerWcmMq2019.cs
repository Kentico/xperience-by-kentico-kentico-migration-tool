...
{
    [Table("Form_Xperience_Gartner_WCM_MQ_2019")]
    public partial class FormXperienceGartnerWcmMq2019
    {
        [Key]
        [Column("Gartner_WCM_MQ_2019_xpID")]
        public int GartnerWcmMq2019XpId { get; set; }
