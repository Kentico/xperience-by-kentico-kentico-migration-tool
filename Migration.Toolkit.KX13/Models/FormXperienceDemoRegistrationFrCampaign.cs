...
{
    [Table("Form_Xperience_DemoRegistration_FR_campaign")]
    public partial class FormXperienceDemoRegistrationFrCampaign
    {
        [Key]
        [Column("DemoRegistration_FR_campaignID")]
        public int DemoRegistrationFrCampaignId { get; set; }
