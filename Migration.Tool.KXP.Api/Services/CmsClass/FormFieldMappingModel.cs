...
using FcLongText = Migration.Tool.Common.Enumerations.Kx13FormControls.UserControlForLongText;
using FcText = Migration.Tool.Common.Enumerations.Kx13FormControls.UserControlForText;
...
{
    public static void PrepareFieldMigrations(ToolConfiguration configuration)
    {
