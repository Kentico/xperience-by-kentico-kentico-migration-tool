...
public class PrimaryKeyMappingContext(ILogger<PrimaryKeyMappingContext> logger,
    ...
    : IPrimaryKeyMappingContext
{
    ...
    {
        foreach (var (sourceId, targetId) in primaryKeyLocatorService.SelectAll(keyNameSelector))
        {
