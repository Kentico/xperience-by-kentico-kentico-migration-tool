...
public class FormDefinitionPatcher
{
    ...
    private const string FIELD_ATTR_PUBLIC_FIELD         = "publicfield"; // K11
    private const string FIELD_ATTR_TRANSLATE_FIELD      = "translatefield"; // K11
    ...
    private void PatchField(XElement field)
    {
        ...
        if (!_classIsForm && !_classIsDocumentType)
        {
            ...
            field.Attribute(FIELD_ATTR_PUBLIC_FIELD)?.Remove();
            field.Attribute(FIELD_ATTR_TRANSLATE_FIELD)?.Remove();
