...
/// Thrown when the provided JSON file path is null, empty, or contains only whitespace.
/// </exception>
/// <exception cref="System.InvalidOperationException">
/// Thrown when the parsed JSON structure is invalid or when the required mapping data is missing.
/// </exception>
